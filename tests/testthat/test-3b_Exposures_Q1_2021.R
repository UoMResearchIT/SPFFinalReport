...
test_that("exposures q1 2021 data matches reference data", {
  ...
  skip_if(!env_should_run_test("SPF_RUN_HLDT_3B"),
          glue::glue("'SPF_RUN_HLDT_3B=false' and 'SPF_RUN_ALL_HLDT=false';",
  ...
  for (k in test_areas) {
    ...
    # Reference data
    path1 <- paste("Output_ref/CaseStudy2/Exposures_Q1_2021/exposures_", k,
                   ".RData", sep = "")

    # Data produced by running package code
    path2 <- paste("Output_act/CaseStudy2/Exposures_Q1_2021/exposures_", k,
                   ".rds", sep = "")

    # Example ref data path:
    #   "Output_ref/CaseStudy2/Exposures_Q1_2021/exposures_E02000984.RData"

    # Example act data path:
    #   "Output_act/CaseStudy2/Exposures_Q1_2021/exposures_E02000984.rds"
