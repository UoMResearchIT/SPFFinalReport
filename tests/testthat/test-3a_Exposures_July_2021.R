...
test_that("exposures jul 2021 data matches reference data", {
  ...
  skip_if_r_cmd_check_or_not_configured("DIMEX_RUN_HLDT_3A")
  ...
  for (k in test_areas) {
    ...
    path2 <- paste("Output/CaseStudy2/Exposures_July_2021/exposures_", k,
                   ".rds", sep = "")
    ...
    #   "Output/CaseStudy2/Exposures_July_2021/exposures_E02000984.rds"
