...
[[D]{.dimex-acronym}ata [I]{.dimex-acronym}ntegration [M]{.dimex-acronym}odel
for personal [EX]{.dimex-acronym}posures]{.subtitle}

### Introduction

This package implements the DIMEX model. The package is derived from the
...
See [development installation](development.hml#install-dev) for development work
on the `dimex` package.
...
See the [Configuration](config.html) vignette for configuration information.
