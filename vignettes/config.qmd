...
This vignette describes how to configure the `spf` package. See the
[introduction to spf](spf.html) vignette for context.
...
System environment variables for the `spf` package start with 'SPF_'.
